...
class TampilPasien implements KontrakPasienView
{
	...
	function tampil()
	{
		...
		for ($i = 0; $i < $this->prosespasien->getSize(); $i++) {
			...
			<td><a href='addNew.php?id_update=" . $i . "' class='btn btn-warning text-light' '>Update</a> <a href='index.php?id_delete= " . $this->prosespasien->getId($i) . "' class='btn btn-danger text-danger''>Hapus</a></td>";
		}
